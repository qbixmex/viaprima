...
export const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden bg-surface-container-low py-24 border-b border-slate-800/60">
      <div className="absolute -top-24 -left-20 size-120 bg-blue-600/15 rounded-full blur-3xl pointer-events-none z-0" />

      <div className="max-w-7xl mx-auto px-gutter z-10">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
          <div className="w-full lg:w-1/2">
            ...
            <p className="font-body-lg text-body-lg text-slate-300 max-w-2xl leading-relaxed mb-2">
              Somos un centro de distribución enfocado en la logística urbana, &nbsp;
              para conectar los centros de operación con el destinatario final.
            </p>
            <p className="font-body-lg text-body-lg text-slate-300 max-w-2xl leading-relaxed">
              En <b><i><span className="text-primary">Via</span><span className="text-secondary">Prima</span></i></b>&nbsp;
              nos especializamos en la recepción, clasificación y preparación de paquetería para su&nbsp;
              entrega a domicilio.
            </p>
            <div className="flex flex-wrap gap-3 mt-7">
              ...
              >
                <Icon icon="material-symbols:timeline" className="text-[20px] text-blue-400" />
                <span>Ver cómo operamos</span>
              </Link>
            </div>
          </div>
          <div className="w-full lg:w-1/2">
            <figure className="bg-black w-full rounded-md overflow-hidden">
              <Image
                src="/images/recepcion-paquetes.png"
                width={1024}
                height={576}
                className="w-full max-w-[768px] md:max-w-[1024px] lg:max-w-full object-cover opacity-85"
                alt="Recepción de paquetes"
              />
            </figure>
          </div>
        </div>
